...
@section('log_content')
    <form id="form1" name="form1" class="form-horizontal" action="{{URL::to('/confirm-register')}}" method="post">
        <div class="page-container">
            <!-- 8.1 home section -->
            <div class="home-section">
                <!-- 8.1.1 logo -->
                <div class="logo">
                    <img class="animated fadeInDown" src="{{asset('public/login/img/logo.png')}}" alt="logo">
                </div>
                <!-- end logo -->
                ...
                <div class="fullpage-section">
                    ...
                    <div
                        ...
                        <h2 class="title-with-border">Đăng ký tài khoản <span class="highlight">User</span></h2>
                        <!-- content -->
                        <div class="content">
                            <p class="desc">
                                Vui lòng nhập đủ các trường để đăng ký.
                            </p>
                        <?php
                        ...
                        <!-- 8.3.2.1 contact form container -->
                            <div class="contact-form-container col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div id="frmlogin" class="col-lg-offset-2 col-md-offset-2 col-lg-8 col-md-8 col-xs-12">
                                    ...
                                    <div class="form-row">
                                        <input id="password" name="user_password_confirm" class="contact-email load-virtual-keyboard"
                                               placeholder="xác nhận mật khẩu" type="password" value="" maxlength="50"
                                               autocomplete="new-password">
                                    </div>
                                    <input id="user_name" name="user_name" class="contact-name load-virtual-keyboard"
                                           placeholder="Tên người dùng" type="text" value="" maxlength="50"
                                           autocomplete="new-password">
                                ...
                                <div class="form-row col-lg-8 col-md-8 col-xs-12 p-t">
                                    <button id="btnsubmit" name="submit" class="button-regular" data-text="Đăng ký">Đăng ký</button>
                                </div>
                                <!-- end contact form -->
                            </div>
