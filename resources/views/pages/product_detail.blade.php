                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-pic-zoom">
                            <img class="product-big-img"
                                 src="{{asset('public/uploads/products/'.$pro_de->product_image)}}" alt="">
                        </div>
                        <div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
                            <div class="product-thumbs-track">
                                <div class="pt active"
                                     data-imgbigurl="{{asset('public/uploads/products/'.$pro_de->product_image)}}"><img
                                        src="{{asset('public/uploads/products/'.$pro_de->product_image)}}" alt=""></div>
                                <div class="pt" data-imgbigurl="{{asset('public/user/img/single-product/2.jpg')}}"><img
                                        src="{{asset('public/user/img/single-product/thumb-2.jpg')}}" alt=""></div>
                                <div class="pt" data-imgbigurl="{{asset('public/user/img/single-product/3.jpg')}}"><img
                                        src="{{asset('public/user/img/single-product/thumb-3.jpg')}}" alt=""></div>
                                <div class="pt" data-imgbigurl="{{asset('public/user/img/single-product/4.jpg')}}"><img
                                        src="{{asset('public/user/img/single-product/thumb-4.jpg')}}" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 product-details">
                        ...
                        <form action="{{URL::to('/save-cart')}}" method="post">
                            ...
                            <button type="submit" class="site-btn">Thên vào giỏ</button>
                        </form>
                            ...
                            <div class="panel">
                                <div class="panel-header" id="headingOne">
                                    <button class="panel-link active" data-toggle="collapse" data-target="#collapse1"
                                            aria-expanded="true" aria-controls="collapse1">Thông Tin
                                    </button>
                                </div>
                            ...
                            <div class="panel">
                                <div class="panel-header" id="headingTwo">
                                    <button class="panel-link" data-toggle="collapse" data-target="#collapse2"
                                            aria-expanded="false" aria-controls="collapse2">Nội dung chi tiết
                                    </button>
                                </div>
                            ...
                            <div class="panel">
                                <div class="panel-header" id="headingThree">
                                    <button class="panel-link" data-toggle="collapse" data-target="#collapse3"
                                            aria-expanded="false" aria-controls="collapse3">Giao hàng và trả lại
                                    </button>
                                </div>
                                <div id="collapse3" class="collapse" aria-labelledby="headingThree"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <p>Thanh toán tiền khi giao hàng<br>Giao hàng tận nhà(<15km)
                                            <span>1 - 2 days</span></p>
                                        <p>Chúng tôi chỉ nhận lại hàng khi có lỗi của nhà xản suất và sẽ khắc phục hoặc
                                            đổi mới cho quý khách.
                                            Sẽ không nhận lại hàng bảo hành khi đó là lỗi của người dùng, nếu có sẽ tính
                                            phí</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            ...
                            <div class="pi-links">
                                ...
                                <a href="{{URL::to('/product-detail/'.$re_pro->product_id)}}" class="wishlist-btn"><i
