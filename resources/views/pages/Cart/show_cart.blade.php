                        ...
                        <table>
                            ...
                            <tr>
                                <td class="product-col">
                                    <img src="{{asset('public/uploads/products/'.$v_content->options->image)}}" alt="">
                                    <div class="pc-title">
                                ...
                                <td class="quy-col">
                                    <div class="quantity">
                                        <div class="pro-qty">
                                            <input type="text" name="quantity" value="{{ $v_content->qty }}" autocomplete="off" size="2">
                                        </div>
                                    </div>
                                </td>
                                ...
                                <th class="total-th"><a href="{{URL::to('/delete-to-cart/'.$v_content->rowId)}}"><i class="fa fa-trash" style="font-size: 25px; margin-top: 10px"></i></a></th>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
                ...
                <div class="product-item">
                    <div class="pi-pic">
                        ...
                        <div class="pi-links">
                            ...
                            <a href="{{URL::to('/product-detail/'.$con_pro->product_id)}}" class="wishlist-btn"><i class="flaticon-heart"></i></a>
                        </div>
                    </div>
                    <div class="pi-text">
