    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{asset('public/uploads/'.Session::get('admin_image'))}}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
...
{{--                                <span class="badge badge-info right">6</span>--}}
                    ...
                    <li class="nav-item" style="border: blue 10px solid; text-align: center;">
